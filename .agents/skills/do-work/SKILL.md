...
do not commit in main or release branches. commit only if we are in a feature branch.
Once typecheck and tests pass, commit the work with a clear, descriptive message.